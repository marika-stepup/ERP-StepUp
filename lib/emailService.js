      ...
      <div class="header">
        <div style="text-align: center; margin-bottom: 6px;">
          <div class="logo-card" style="background-color: #ffffff !important; background: #ffffff !important; padding: 10px 24px; border-radius: 10px; display: inline-block; border: 1px solid #e2e8f0;">
            <img src="cid:stepup_logo" alt="Step Up" class="header-logo" style="height: 90px; width: auto; max-width: 320px; display: inline-block; object-fit: contain; vertical-align: middle;" />
          </div>
        </div>
